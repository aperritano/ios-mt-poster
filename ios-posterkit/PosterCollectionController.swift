...
class PosterCollectionController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        SwiftEventBus.onMainThread(self, name: "PosterReloadedEvent") {
            _ in
            self.reloadWithDBHelper()
        }
    }
    ...
    @IBAction func DeleteCellAction(sender: MKButton) {
        ...
        SweetAlert().showAlert("Are you sure?", subTitle: "This POSTER and all of its POSTER ITEMS will be permanently deleted!", style: AlertStyle.Warning, buttonTitle: "Cancel", buttonColor: UIColor.paperColorBlue400(), otherButtonTitle: "YES", otherButtonColor: UIColor.paperColorRed()) {
