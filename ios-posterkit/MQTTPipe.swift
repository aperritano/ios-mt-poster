...
class MQTTPipe {
    ...
    init() {
        ...
        mqttInstance.connectToHost(kMQTTServerHost, completionHandler: {
            (code: MQTTConnectionReturnCode) -> Void in
...
//            }
    ...
    func subscribeTopic(topic: String) {
        ...
        mqttInstance.subscribe("IAMPOSTER.OUT", withCompletionHandler: {
            grantedQos in
    ...
    func sendMessage(message: String) {
        ...
        mqttInstance.publishString(message, toTopic: "IAMPOSTERIN", withQos: AtMostOnce, retain: false, completionHandler: {
            mid in
