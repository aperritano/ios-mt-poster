...
public class FrostedSidebar: UIViewController {
    ...
    public var showFromRight: Bool = true
    public var animationDuration: CGFloat = 0.25
    public var itemSize: CGSize = CGSize(width: 120.0, height: 120.0)
    public var tintColor: UIColor = UIColor(white: 1, alpha: 0.73)
    public var itemBackgroundColor: UIColor = UIColor(white: 0.25, alpha: 0.25)
